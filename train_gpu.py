...
def get_args_parser():
    parser = argparse.ArgumentParser(
        'FasterViT training and evaluation script', add_help=False)
    parser.add_argument('--batch-size', default=8, type=int)
    parser.add_argument('--epochs', default=5, type=int)
    parser.add_argument('--predict', default=True, type=bool, help='plot ROC curve and confusion matrix')

    # Model parameters
    parser.add_argument('--model', default='faster_vit_1_224', type=str, metavar='MODEL',
                        choices=['faster_vit_0_224', 'faster_vit_1_224', 'faster_vit_2_224', 'faster_vit_3_224', 'faster_vit_4_224', \
                                 'faster_vit_5_224', 'faster_vit_6_224', 'faster_vit_4_21k_224', 'faster_vit_4_21k_384', 'faster_vit_4_21k_512', \
    ...
    # Finetuning params
    parser.add_argument('--finetune', default='./fastervit_1_224_1k.pth',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        'FasterViT training and evaluation script', parents=[get_args_parser()])
